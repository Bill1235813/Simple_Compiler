...
public class FixtureDefinitions {
	public static final String FIXTURE_DIRECTORY = "src/lexicalAnalyzer/tests/fixtures/";
	...
	public static final String STRING_INPUT_FILENAME = FIXTURE_DIRECTORY + "stringTest.pika";
	public static final String STRING_EXPECTED_FILENAME = FIXTURE_DIRECTORY + "stringResult.txt";
}
