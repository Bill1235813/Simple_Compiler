        ...
        Add                                    
        Exchange                               
        Label        -recursive-print-array-55-startflag 
        Duplicate                              
        JumpFalse    -recursive-print-array-55-endflag 
        Label        -recursive-print-array-55-loopflag 
        Exchange                               
        Duplicate                              
        LoadI                                  
        Duplicate                              
        ...
        PushD        $array-print-middle       
        Printf                                 
        Jump         -recursive-print-array-55-loopflag 
        Label        -recursive-print-array-55-endflag 
        Pop                                    
        Pop                                    
        PushD        $array-print-end          
        Printf                                 
        ...
        Exchange                               
        StoreI                                 
        Label        -function-insert-54-loopflag 
        PushD        $insert-size-temp         
        LoadI                                  
        JumpFalse    -function-insert-54-endflag 
        PushD        insert-location-temp      
        LoadI                                  
        Exchange                               
        StoreC                                 
        ...
        Exchange                               
        StoreI                                 
        Jump         -function-insert-54-loopflag 
        Label        -function-insert-54-endflag 
        PushD        $record-creation-temporary 
        LoadI                                  
        PushI        8                         
        Add                                    
        ...
        Add                                    
        Exchange                               
        Label        -recursive-print-array-56-startflag 
        Duplicate                              
        JumpFalse    -recursive-print-array-56-endflag 
        Label        -recursive-print-array-56-loopflag 
        Exchange                               
        Duplicate                              
        LoadI                                  
        Duplicate                              
        ...
        PushD        $array-print-middle       
        Printf                                 
        Jump         -recursive-print-array-56-loopflag 
        Label        -recursive-print-array-56-endflag 
        Pop                                    
        Pop                                    
        PushD        $array-print-end          
        Printf                                 
