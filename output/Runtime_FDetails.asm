        ...
        Add                                    %% array_rebuild
        PushPC                                 
        Jump         -function-definition-12-ends 
        Label        -function-definition-12-starts 
        PushD        $stack-pointer            
        LoadI                                  
        Duplicate                              
        PushI        -4                        
        ...
        LoadI                                  
        Subtract                               
        JumpNeg      -array-indexing-6-startflag 
        Jump         $$array-size-is-out-of-bound 
        Label        -array-indexing-6-startflag 
        PushD        $a-indexing-array         
        LoadI                                  
        PushI        16                        
        Add                                    
        ...
        LoadI                                  
        Subtract                               
        JumpNeg      -array-indexing-8-startflag 
        Jump         $$array-size-is-out-of-bound 
        Label        -array-indexing-8-startflag 
        PushD        $a-indexing-array         
        LoadI                                  
        PushI        16                        
        Add                                    
        ...
        Add                                    
        Exchange                               
        Label        -recursive-print-array-10-startflag 
        Duplicate                              
        JumpFalse    -recursive-print-array-10-endflag 
        Label        -recursive-print-array-10-loopflag 
        Exchange                               
        Duplicate                              
        LoadI                                  
        ...
        Printf                                 
        Jump         -recursive-print-array-10-loopflag 
        Label        -recursive-print-array-10-endflag 
        Pop                                    
        Pop                                    
        ...
        Exchange                               
        StoreI                                 
        Label        -clone-array-11-loopflag  
        PushD        clone-size-temp           
        LoadI                                  
        JumpFalse    -clone-array-11-endflag   
        PushD        clone-location-temp       
        LoadI                                  
        LoadC                                  
        PushD        clone-new-location-temp   
        ...
        Exchange                               
        StoreI                                 
        Jump         -clone-array-11-loopflag  
        Label        -clone-array-11-endflag   
        PushD        $record-creation-temporary 
        LoadI                                  
        PushI        12                        
        Add                                    
        ...
        Label        -function-definition-12-ends 
        PushI        1                         
        Add                                    
        StoreI                                 
        PushD        $global-memory-block      
